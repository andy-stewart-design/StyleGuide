<section class="relative h-screen bg-black">
	<div class="absolute top-0 left-0 w-full h-64 bg-gradient-to-b from-black opacity-60 z-10" />
	<img
		class="w-full h-full object-cover opacity-50"
		src="https://teague.com/uploads/default/_2400x1585_crop_center-center_75_line/Hannah-Starbucks.jpg"
		alt="fpo"
	/>
</section>
